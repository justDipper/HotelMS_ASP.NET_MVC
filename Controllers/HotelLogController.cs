...
{
    public class HotelLogController : Controller
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<HotelLogController> _logger; // Add ILogger

        public HotelLogController(ILogger<HotelLogController> logger)
        {
            _httpClient = new HttpClient
            {
                BaseAddress = new Uri("https://localhost:7102/HotelLog")
            };
        ...
        //CREATE
        [HttpPost]
        public async Task<IActionResult> Add(HotelLogModel book)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var request = new HttpRequestMessage(HttpMethod.Post, "HotelLog");
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        return RedirectToAction("Index", "HotelLog");
                    }
                    else
                    {
                        // Handle error response
                        return RedirectToAction("Add", "HotelLog");
                    }
                }
                else
                {
        ...
        public async Task<ActionResult> Index()
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var userAcc = await response.Content.ReadAsAsync<List<HotelLogModel>>();
                    return View(userAcc);
                }
                else
                {
        ...
        public async Task<ActionResult> Edit(int id)
        {
            try
            {
                ...
                var response = await _httpClient.GetAsync($"HotelLog/{id}");
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (json != null)
                    {
                        // If it's an array, deserialize it as a List<HotelLog>
                        var userAccList = JsonConvert.DeserializeObject<List<HotelLogModel>>(json);
                        ...
                        else
                        {
                            ...
                            return RedirectToAction("Edit", "HotelLog");
                        }
                    }
                    else
                    {
                        // If it's not an array, deserialize it as a single HotelLog object
                        var userAcc = JsonConvert.DeserializeObject<HotelLogModel>(json);
                        return View(userAcc);
                    }
                }
                else
        ...
        public async Task<IActionResult> Edit(HotelLogModel userAcc)
        {
            try
            {
                if (userAcc == null)
                ...
                var request = new HttpRequestMessage(HttpMethod.Put, "HotelLog");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    return RedirectToAction("Index", "HotelLog"); // Assuming there's an Index action method to redirect to
                }
                else
                {
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (json != null)
                    {
                        ...
                        {
                            // Handle the case where the array is empty
                            return RedirectToAction("HotelLog", "Edit");
                        }
                    }
                    else
                    {
            ...
            {
                // Handle exception
                return RedirectToAction("HotelLog", "HotelLog");
            }
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                var request = new HttpRequestMessage(HttpMethod.Delete, $"HotelLog/{id}");
                var response = await _httpClient.SendAsync(request);
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    return RedirectToAction("Index", "HotelLog"); // Assuming there's an action method to redirect to
                }
                else
                {
                    // Log error or handle the error response appropriately
